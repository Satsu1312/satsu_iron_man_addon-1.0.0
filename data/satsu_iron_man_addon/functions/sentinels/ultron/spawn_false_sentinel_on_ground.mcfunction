...
execute if entity @s[tag=grave.facing.east] run summon wolf ~1 ~ ~ {CustomNameVisible:1b,CustomName:'{"translate":"satsu.iron.man.addon.entity.name.armor.sentinel"}',Silent:1b,Tags:["tamed_wolf","new","sentinel"]}
...
execute if entity @s[tag=grave.facing.north] run summon armor_stand ~ ~ ~-1 {Marker:1b,Invisible:1b,Invulnerable:1b,Silent:1b,NoBasePlate:1b,CustomName:'{"translate":"satsu.iron.man.addon.entity.name.armor.sentinel"}',NoGravity:1b,Tags:["sentinel"],Pose:{Body:[0f,0f,0f],LeftArm:[0f,0f,0f],RightArm:[0f,0f,0f],LeftLeg:[0f,0f,0f],RightLeg:[0f,0f,0f],Head:[0f,0f,0f]}}
execute if entity @s[tag=grave.facing.south] run summon armor_stand ~ ~ ~1 {Marker:1b,Invisible:1b,Invulnerable:1b,Silent:1b,NoBasePlate:1b,CustomName:'{"translate":"satsu.iron.man.addon.entity.name.armor.sentinel"}',NoGravity:1b,Tags:["sentinel"],Pose:{Body:[0f,0f,0f],LeftArm:[0f,0f,0f],RightArm:[0f,0f,0f],LeftLeg:[0f,0f,0f],RightLeg:[0f,0f,0f],Head:[0f,0f,0f]}}
execute as @e[type=minecraft:armor_stand,tag=sentinel,limit=1,sort=nearest] run superpower add satsu_iron_man_addon:ia_stuff/ultron/iron_man_sentinel @s
