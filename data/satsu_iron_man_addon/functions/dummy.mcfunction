...
scoreboard objectives remove satsu.iron.man.armor.hud.enabled
...
scoreboard objectives remove satsu.iron.man.addon.nano.stabilizer
...
scoreboard objectives remove satsu.iron.man.armor.ark.energy dummy
scoreboard objectives remove satsu.iron.man.armor.ark.energy.max dummy
