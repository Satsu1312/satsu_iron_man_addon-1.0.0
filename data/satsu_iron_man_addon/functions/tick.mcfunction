...
execute as @p[scores={satsu.iron.man.addon.ia.name.power=1}] run superpower add satsu_iron_man_addon:ia_stuff/ia @s
execute as @p[scores={satsu.iron.man.addon.ia.name.power=1}] run superpower add satsu_iron_man_addon:ia_stuff/ia_voice_commands @s
