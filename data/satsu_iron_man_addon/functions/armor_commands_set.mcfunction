...
execute as @s[scores={satsu.iron.man.armor=0}] run scoreboard players set @s satsu.iron.man.durability 10
execute as @s[scores={satsu.iron.man.armor=0}] run scoreboard players set @s satsu.iron.man.strength 3
...
execute as @s[scores={satsu.iron.man.armor=1}] run scoreboard players set @s satsu.iron.man.durability 35
...
execute as @s unless score @s satsu.iron.man.armor.6.unlock matches ..1 as @s[scores={satsu.iron.man.armor=6}] run scoreboard players reset @s satsu.iron.man.armor.actived
execute as @s unless score @s satsu.iron.man.armor.6.unlock matches ..1 as @s[scores={satsu.iron.man.armor=6}] run scoreboard players reset @s satsu.iron.man.armor.actived.perm
execute as @s[scores={satsu.iron.man.armor=7}] run scoreboard players set @s satsu.iron.man.flame 10
execute as @s[scores={satsu.iron.man.armor=7}] run scoreboard players set @s satsu.iron.man.durability 11
execute as @s[scores={satsu.iron.man.armor=7}] run scoreboard players set @s satsu.iron.man.strength 7
execute as @s unless score @s satsu.iron.man.armor.7.unlock matches ..1 as @s[scores={satsu.iron.man.armor=7}] run scoreboard players reset @s satsu.iron.man.armor.actived
execute as @s unless score @s satsu.iron.man.armor.7.unlock matches ..1 as @s[scores={satsu.iron.man.armor=7}] run scoreboard players reset @s satsu.iron.man.armor.actived.perm
