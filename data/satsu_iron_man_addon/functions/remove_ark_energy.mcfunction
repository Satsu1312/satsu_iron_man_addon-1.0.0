...
execute as @s[scores={satsu.iron.man.armor.ark.energy=0..9980}] as @s[scores={satsu.iron.man.ark.upgraded=2}] run scoreboard players add @s satsu.iron.man.armor.ark.energy 2
execute as @s unless score @s satsu.iron.man.ark.upgraded matches 2 as @s[scores={satsu.iron.man.armor.actived.perm=1}] as @s[tag=!sentinel_one,scores={satsu.iron.man.armor.ark.energy=1..}] as @s run scoreboard players remove @s satsu.iron.man.armor.ark.energy 1
