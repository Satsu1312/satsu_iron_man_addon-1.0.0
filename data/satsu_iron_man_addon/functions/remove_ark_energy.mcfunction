...
execute as @s[scores={satsu.iron.man.armor.actived.perm=1}] as @s[scores={satsu.iron.man.armor.ark.energy=1..10000}] as @s[scores={satsu.iron.man.armor=2..11}] run scoreboard players remove @s satsu.iron.man.armor.ark.energy 1
