...
execute as @s[scores={satsu.iron.man.armor.ark.energy=0..9998}] as @s[scores={satsu.iron.man.ark.upgraded=2}] run scoreboard players add @s satsu.iron.man.armor.ark.energy 2
execute as @s[scores={satsu.iron.man.armor.actived.perm=1}] as @s[scores={satsu.iron.man.armor.ark.energy=1..}] as @s run scoreboard players remove @s satsu.iron.man.armor.ark.energy 1
