PalladiumEvents.registerAnimations((event) => {
  event.register("satsu_iron_man_addon/marks/mark_extremis/blade_attack", 10, (builder) => {
  ...
  event.register("satsu_iron_man_addon/marks/mark_extremis/blade_attack_2", 10, (builder) => {
    // Gets the current animation timer progress from the ability, returned value is a number from 0.0 to 1.0
    const progress = animationUtil.getAnimationTimerAbilityValue(
      builder.getPlayer(),
      "satsu_iron_man_addon:marks/mark_extremis/main",
