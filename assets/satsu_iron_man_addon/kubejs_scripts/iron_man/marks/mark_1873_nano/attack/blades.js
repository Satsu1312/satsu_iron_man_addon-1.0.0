PalladiumEvents.registerAnimations((event) => {
  event.registerForPower("satsu_iron_man_addon/marks/mark_1873_nano/blade_attack",
  ...
  event.registerForPower("satsu_iron_man_addon/marks/mark_1873_nano/blade_attack_2",
      "satsu_iron_man_addon:iron_man/marks/mark_1873_nano/main", 10, (builder) => {
    // Gets the current animation timer progress from the ability, returned value is a number from 0.0 to 1.0
    const progress = animationUtil.getAnimationTimerAbilityValue(
      builder.getPlayer(),
