...
PalladiumEvents.registerAnimations((event) => {
  event.registerForPower("satsu_iron_man_addon/marks/model_prime/shield_put_animation.hulkbuster", 
      "satsu_iron_man_addon:iron_man/marks/model_prime/main",12, (builder) => {
