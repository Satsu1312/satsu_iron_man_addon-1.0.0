...
PalladiumEvents.registerAnimations((event) => {
  event.registerForPower(
    "satsu_iron_man_addon/marks/mark_extremis/main-left-arm",
  ...
  event.registerForPower(
    "satsu_iron_man_addon/marks/mark_extremis/main-right-arm",
        "satsu_iron_man_addon:iron_man/marks/mark_extremis/main",
    10,
    (builder) => {
      // Gets the current animation timer progress from the ability, returned value is a number from 0.0 to 1.0
  ...
  event.registerForPower(
    "satsu_iron_man_addon/marks/mark_extremis/main-left-leg",
        "satsu_iron_man_addon:iron_man/marks/mark_extremis/main",
    10,
    (builder) => {
      // Gets the current animation timer progress from the ability, returned value is a number from 0.0 to 1.0
  ...
  event.registerForPower(
    "satsu_iron_man_addon/marks/mark_extremis/main-right-leg",
        "satsu_iron_man_addon:iron_man/marks/mark_extremis/main",
    10,
    (builder) => {
      // Gets the current animation timer progress from the ability, returned value is a number from 0.0 to 1.0
