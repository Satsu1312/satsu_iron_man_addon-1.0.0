...
PalladiumEvents.registerAnimations((event) => {
  event.registerForPower(
    "satsu_iron_man_addonmarks/additamens/hammers/maindrill.ground.1",
  ...
  event.registerForPower(
    "satsu_iron_man_addonmarks/additamens/hammers/drill_repeating.ground.2_left",
        "satsu_iron_man_addon:marks/additamens/hammers/main",
    10,
    (builder) => {
      // Gets the current animation timer progress from the ability, returned value is a number from 0.0 to 1.0
  ...
  event.registerForPower(
    "satsu_iron_man_addonmarks/additamens/hammers/drill_repeating.ground.2_right",
        "satsu_iron_man_addon:marks/additamens/hammers/main",
    10,
    (builder) => {
      // Gets the current animation timer progress from the ability, returned value is a number from 0.0 to 1.0
