...
PalladiumEvents.registerAnimations((event) => {
  event.registerForPower(
    "satsu_iron_man_addon/remove.ark.animation",
  ...
  event.registerForPower(
    "satsu_iron_man_addon/remove.ark.animation.2",
        "satsu_iron_man_addon:items/handle",
    10,
    (builder) => {
      // Gets the current animation timer progress from the ability, returned value is a number from 0.0 to 1.0
...
PalladiumEvents.registerAnimations((event) => {
  event.registerForPower(
    "satsu_iron_man_addon/dampened_ark",
  ...
  event.registerForPower("satsu_iron_man_addon/dampened_ark.2",
      "satsu_iron_man_addon:items/dampened_ark", 10, (builder) => {
    // Gets the current animation timer progress from the ability, returned value is a number from 0.0 to 1.0
    const progress = animationUtil.getAnimationTimerAbilityValue(
      builder.getPlayer(),
      "satsu_iron_man_addon:items/dampened_ark",
