...
PalladiumEvents.registerPropertiesClientSided((event) => {
  ...
  if (event.getEntityType() === "minecraft:player" || "palladium:custom_projectile") {
      // Arguments: Key of the property, type of the property, default/starting value
      event.registerProperty('satsu_iron_man_armor_arc_energy_max', 'integer', 10000);
    }
});
PalladiumEvents.registerPropertiesClientSided((event) => {
  // Only register for players
  if (event.getEntityType() === "minecraft:player" || "palladium:custom_projectile") {
      // Arguments: Key of the property, type of the property, default/starting value
      event.registerProperty('satsu_iron_man_flight_speed_choose', 'integer', 0);
    }
});
PalladiumEvents.registerPropertiesClientSided((event) => {
  // Only register for players
...
PalladiumEvents.registerPropertiesClientSided((event) => {
  ...
  if (event.getEntityType() === "minecraft:player" || "minecraft:armor_stand") {
    // Arguments: Key of the property, type of the property, default/starting value
    event.registerProperty("satsu_iron_man_addon_device_repulser", "string", "odd");
  }
});
PalladiumEvents.registerPropertiesClientSided((event) => {
  // Only register for players
...
PalladiumEvents.registerPropertiesClientSided((event) => {
  ...
  if (event.getEntityType() === "minecraft:player" || "palladium:custom_projectile") {
    // Arguments: Key of the property, type of the property, default/starting value
    event.registerProperty("satsu_iron_man_addon_shield_enabled", "string", "off");
  }
});
PalladiumEvents.registerPropertiesClientSided((event) => {
