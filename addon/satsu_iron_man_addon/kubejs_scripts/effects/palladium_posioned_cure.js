...
StartupEvents.registry("mob_effect", (event) => {
  event
    .create("satsu_iron_man_addon:palladium_posioned_cure")
    .displayName("Palladium Poisoned")
    .effectTick((entity, lvl) => {
      ...
      superpowerUtil.addSuperpower(entity, "satsu_iron_man_addon:effect/palladium_posioned_cure");
    })
